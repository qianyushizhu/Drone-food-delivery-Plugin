...
import{search_servers,webserver_servers} from '../../servers/servers'
...
// const host = 'wxs://mqtt-cn-nif23wlvc1c.mqtt.aliyuncs.com:443';
Page({
  ...
  data: {
    ...
    options: {
      ...
      // clientId: [],
      clientId:"GID_demo@@@demo3",
      clean: false,
      // password: 'Eker5trdkLp2MTT',
      // username: 'yuan-antwork-001',
      password: 'niPC+N/gFlEuACLx0GN9gKrtTlI=',
      username: 'Signature|LTAI5tDWyvCLzvh34z97RAVs|mqtt-cn-nif23wlvc1c',
  ...
  previewerweima(e){
    ...
    let result=[]
    let photo=this.data.orderList.takeFoodQRCode
  ...
  onLoad: function (options) {
    ...
    // })
    //   // 仅订阅单个主题
    //   that.data.client.subscribe('demo', function(err, granted) {
    //     if (!err) {
    //       // wx.showToast({
    //       //   title: '订阅主题成功'
    //       // })
